...
public class TestMapLoader {
	...
	private String RESOURCE_BASE_PATH = "src/resources";
	
	//FIXME: Problems to make this to run, I had problems to initiaze the ResourceManager
	//It had to be initialized inside the "game loop" have to make some kind mocketimock tha
