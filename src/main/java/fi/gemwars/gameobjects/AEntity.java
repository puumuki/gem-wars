...
/**
 * Base class for all the objects of the game. So where is the encapsulation?
...
public abstract class AEntity implements Comparable<AEntity>, IGameObject {
	...
	/**
	 * How fast the entity is moving. If the value is negative the object is
	 * stationary.
	 */
	public double speed;

	/**
	 * Layer number means a drawing order. Entities with smallest numbers are drawn
	 * first.
	 */
	public int layer;
	...
	/**
	 * If this is set to true entity should not be drawn of effect any how to the
	 * game play
	 */
	 ...
	 * @param grap Use this Graphics object to draw the entity so the drawing order
	 *             is right.
	 * @throws SlickException if something goes wrong
	 */
	@Override
	public abstract void render(GameContainer cont, Graphics grap) throws SlickException;

	/**
	 * In this method an entity's physics are updated, input from user are handled
	 * and so on.
	 * 
	 * @param cont  the container of the game, can give us the input of the player
	 *              for example
	 * @param delta
	 * @throws SlickException if something goes wrong
	 */
	@Override
	public abstract void update(GameContainer cont, int delta) throws SlickException;
	...
	/**
	 * Init positions with given values, this means starting position and current
	 * positions.
	 */
