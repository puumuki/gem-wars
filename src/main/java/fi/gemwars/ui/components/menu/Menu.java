package fi.gemwars.ui.components.menu;
...
public class Menu extends AEntity implements IGameObject, Iterable<IMenuItem> {
	...
	/**
	 * Constructor for creating menu with an arial font that is filled with a
	 * gradient color.
	 * 
	 * @param fontTopColor
	 ...
	 * 
	 * @param menuItemName
	 * @return true if menu item is selected otherwise false. If a null reference or
	 *         a non existing menu item name is passes return false.
	 */
